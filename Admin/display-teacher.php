...
<html lang="en">
	...
	?>
		<div class="container  mt-1 border border-secondary mb-1">
				...
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h5>Barcode ID:</h5> <?php echo $row['cnic']  ?><br><br>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>10th Complition Date:</h5> <?php echo $row['matric_complition_date']  ?></div>
				<div class="col-md-4"><h5>10th Admission Date:</h5> <?php echo $row['matric_awarded_date']  ?></div>
				<div class="col-md-4"><h5>10th Certificate:</h5> <?php echo $row['matric_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>12th Complition Date:</h5> <?php echo $row['fa_complition_date']  ?></div>
				<div class="col-md-4"><h5>12th Admission Date:</h5> <?php echo $row['fa_awarded_date']  ?></div>
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>BA Admission Date:</h5> <?php echo $row['ba_awarded_date']  ?></div>
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>MA Admission Date:</h5> <?php echo $row['ma_awarded_date']  ?></div>
