									...
									<div class="modal-body">
										<form action="teacher.php" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">10th Admission Date:</label>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">12th Admission Date:</label>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">BA Admission Date:</label>
